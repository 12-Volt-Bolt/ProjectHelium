...
public class RightAuto extends CommandGroup {
    ...
    public RightAuto() {
    	...
    	//7 feet 9.25 INCHES IS DISTANCE FROM WALL to baseline, still need to adjust time and tolerance, and distance might need to be adjusted cuz robot space, also peg space 9 in, our collector is 3.5, 9-3.5=?
