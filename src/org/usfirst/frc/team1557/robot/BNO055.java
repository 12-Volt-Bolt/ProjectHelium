 ...
 *
 */
public class BNO055 implements PIDSource {
	// Tread variables
	...
	private static double[] savedInitValues = new double[] { 0, 0, 0 };
	...
	public double pidGet() {
		// TODO Auto-generated method stub
		double gyroAngle = this.getRotations()[0];
